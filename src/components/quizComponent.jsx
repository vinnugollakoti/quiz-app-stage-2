        ...
        <center>
          ...
          <div className="options">
            <div className="options-1">
              <button className="optionBtn">{currentQuestion.optionA}</button> &nbsp;&nbsp;
              <button className="optionBtn">{currentQuestion.optionB}</button>
            </div>
            <div className="options-2">
              <button className="optionBtn">{currentQuestion.optionC}</button> &nbsp;&nbsp;
              <button className="optionBtn">{currentQuestion.optionD}</button>
            </div>
            <div className="options-3">
              ...
              <Link to={"/result"}><button className="quitName">Quit</button></Link>&nbsp;
            </div>
          </div>
        </center>
      </div>
